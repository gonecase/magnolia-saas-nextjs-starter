module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      "8xl": ["5.5rem", { lineHeight: "7.0rem" }], // 88px
      "7xl": ["5rem", { lineHeight: "6.5rem" }], // 80px
      "6.5xl": ["4.4rem", { lineHeight: "6.5rem" }], // 70px
      "6xl": ["4rem", { lineHeight: "4.5rem" }], // 64px
      "5.5xl": ["3.875rem", { lineHeight: "4.5rem" }], // 56px
      "5xl": ["3.75rem", { lineHeight: "4.5rem" }], // 56px
      "4.5xl": ["3.4rem", { lineHeight: "4.2rem" }], // 56px
      ...
      "2md": ["1.25rem", { lineHeight: "2.25rem" }], // 24px
